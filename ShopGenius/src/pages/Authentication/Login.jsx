...
import { FaEyeSlash, FaSpinner } from "react-icons/fa6";
...
const Login = () => {
  ...
  // Remembered email UX (email only)
  ...
  const handleUserSignIn = async (e) => {
    ...
    try {
      ...
      // Only store after successful login (email only)
        ...
        <div className="flex items-center w-full max-w-sm mx-auto overflow-hidden bg-white rounded-lg shadow-lg dark:bg-gray-800 lg:max-w-4xl">
          ...
          <div className="w-full px-6 py-8 md:px-8 lg:w-1/2">
            <div className="flex justify-center mx-auto">
              <img className="w-20 h-20 object-cover sm:h-8" src={logo} alt="ShopGenius logo" />
            </div>
            ...
            <button
              ...
              className="btn w-full flex items-center justify-center mt-4 text-gray-600 transition-colors duration-300 transform border rounded-lg dark:border-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-600"
            >
              {googleLoading ? (
            ...
            <form onSubmit={handleUserSignIn}>
              ...
              <div className="mt-4 relative">
                ...
                <button
                  ...
                  onClick={() => setPasswordToggle((s) => !s)}
                >
                  {passwordToggle ? <FaEyeSlash /> : <IoMdEye />}
                </button>
